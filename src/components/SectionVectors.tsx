...
export const HeartVector = () => (
  <div className="absolute top-4 left-1/2 transform -translate-x-1/2 z-10">
    <svg className="w-8 h-8 text-[var(--color-secondary)] animate-pulse" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
...
export const ClockVector = () => (
  <div className="absolute top-4 left-1/2 transform -translate-x-1/2 z-10">
    <svg className="w-8 h-8 text-[var(--color-secondary)] animate-spin-slow" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
...
export const CalendarVector = () => (
  <div className="absolute top-4 left-1/2 transform -translate-x-1/2 z-10">
    <svg className="w-8 h-8 text-[var(--color-secondary)] animate-bounce-gentle" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
...
export const CameraVector = () => (
  <div className="absolute top-4 left-1/2 transform -translate-x-1/2 z-10">
    <svg className="w-8 h-8 text-[var(--color-secondary)] animate-float" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
...
export const DressVector = () => (
  <div className="absolute top-4 left-1/2 transform -translate-x-1/2 z-10">
    <svg className="w-8 h-8 text-[var(--color-secondary)] animate-sway" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
      <path d="M8 2v4"/>
      <path d="M16 2v4"/>
...
export const GiftVector = () => (
  <div className="absolute top-4 left-1/2 transform -translate-x-1/2 z-10">
    <svg className="w-8 h-8 text-[var(--color-secondary)] animate-wiggle" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
...
export const ShareVector = () => (
  <div className="absolute top-4 left-1/2 transform -translate-x-1/2 z-10">
    <svg className="w-8 h-8 text-[var(--color-secondary)] animate-ping-gentle" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
...
export const RSVPVector = () => (
  <div className="absolute top-4 left-1/2 transform -translate-x-1/2 z-10">
    <svg className="w-8 h-8 text-[var(--color-secondary)] animate-envelope" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
...
export const ThankYouVector = () => (
  <div className="absolute top-4 left-1/2 transform -translate-x-1/2 z-10">
    <svg className="w-8 h-8 text-[var(--color-secondary)] animate-heartbeat" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
      <path d="M20.84 4.61a5.5 5.5 0 0 0-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 0 0-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 0 0 0-7.78z"/>
